...
- base.html - базовый шаблон с header, footer, навигацией, содержит блок scripts для подключения JavaScript файлов
